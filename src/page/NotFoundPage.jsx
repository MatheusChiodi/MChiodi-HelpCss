  ...
  return (
    <main className="mx-auto flex h-screen max-w-4xl flex-col items-center justify-center px-4 text-center">
      <motion.div
        ...
        className="space-y-4"
      >
        <h1 className="text-7xl font-extrabold text-[#ff5555]">404</h1>
        ...
        <Link
          to="/"
          className="inline-block rounded-full bg-[#ff5555] px-6 py-3 text-sm font-medium text-white transition hover:brightness-90 md:text-base"
        >
          Voltar para Home
        </Link>
      </motion.div>
